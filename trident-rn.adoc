...
* Analisi migliorata dei nomi degli iniziatori iSCSI. (Numero [n. 681](https://github.com/NetApp/trident/issues/681[]))
* Risolto il problema a causa del quale i parametri della classe di storage CSI non erano consentiti. (Numero [n. 598](https://github.com/NetApp/trident/issues/598[]))
* È stata corretta la dichiarazione della chiave duplicata in Trident CRD. (Numero [n. 671](https://github.com/NetApp/trident/issues/671[]))
* Sono stati corretti registri Snapshot CSI imprecisi. (Numero [n. 629](https://github.com/NetApp/trident/issues/629[]))
* Risolto il problema di annullamento della pubblicazione dei volumi sui nodi cancellati. (Numero [n. 691](https://github.com/NetApp/trident/issues/691[]))
* Aggiunta la gestione delle incoerenze del file system sui dispositivi a blocchi. (Numero [n. 656](https://github.com/NetApp/trident/issues/656[]))
* Risolto il problema di recupero delle immagini con supporto automatico durante l'impostazione di `imageRegistry` flag durante l'installazione. (Numero [n. 715](https://github.com/NetApp/trident/issues/715[]))
...
* Le connessioni in entrata agli endpoint sicuri di Trident ora richiedono almeno TLS 1.3. (Numero [n. 698](https://github.com/NetApp/trident/issues/698[]))
...
* *Kubernetes*: Trident demonset ora funziona con la classe di priorità system-node-critical. (Numero [n. 694](https://github.com/NetApp/trident/issues/694[]))
