...
| `limitVolumeSize` | Fallire il provisioning se la dimensione del volume richiesta è superiore a questo valore per il driver economico. | "" (non applicato per impostazione predefinita) 
